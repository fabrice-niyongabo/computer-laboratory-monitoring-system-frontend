            ...
            <CCardHeader>
              <div className="d-flex justify-content-between">
                ...
                <div className="d-flex justify-content-between">
                  ...
                  <div>&nbsp; &nbsp;</div>
                  <Link
                    to={`/printer/repaired/?repairedDate=${dateFilter}&pcDetails__serialNumber=${keyWord}&description=${keyWord}&pcDetails__model=${keyWord}&technician__techNames=${keyWord}&school=${keyWord}`}
                    target="_blank"
                  >
