            ...
            <CCardHeader>
              <div className="d-flex justify-content-between">
                ...
                <div className="d-flex justify-content-between">
                  ...
                  <div>&nbsp; &nbsp;</div>
                  <Link
                    to={`/printer/archieved/?archievedDate=${dateFilter}&pcDetails__serialNumber=${keyWord}&description=${keyWord}&pcDetails__model=${keyWord}&school=${keyWord}&sector=${keyWord}`}
                    target="_blank"
                  >
