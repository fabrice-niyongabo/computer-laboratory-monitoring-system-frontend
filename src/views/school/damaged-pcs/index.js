...
const DamagedPcs = () => {
  ...
  const fetchPcs = () => {
    setIsLoading(true);
    Axios.get(BACKEND_URL + "/" + mainPath + "/damagedPc/?token=" + token)
      .then((res) => {
        setTimeout(() => {
          setIsLoading(false);
            ...
            <CCardHeader>
              <div className="d-flex justify-content-between">
                ...
                <div className="d-flex justify-content-between">
                  ...
                  <div>&nbsp; &nbsp;</div>
                  <Link
                    to={`/printer/damagedPc/?damagedDate=${dateFilter}&pcDetails__serialNumber=${keyWord}&description=${keyWord}&pcDetails__model=${keyWord}`}
                    target="_blank"
                  >
